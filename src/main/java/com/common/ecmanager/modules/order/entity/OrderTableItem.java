...
public class OrderTableItem extends DataEntity<OrderTableItem> {
	...
	private String reMemberName; //分享人
	private String reMemberIdString; //分享人ID
	private String reMemberPhone;  //分享人电话
	
	private String returnStatus;   //退货状态（1退货成功 2退货失败 3退货中 ）
	...
	public String getReMemberIdString() {
		return reMemberIdString;
	}

	public void setReMemberIdString(String reMemberIdString) {
		this.reMemberIdString = reMemberIdString;
	}

	public String getReMemberPhone() {
		return reMemberPhone;
	}

	public void setReMemberPhone(String reMemberPhone) {
		this.reMemberPhone = reMemberPhone;
	}
