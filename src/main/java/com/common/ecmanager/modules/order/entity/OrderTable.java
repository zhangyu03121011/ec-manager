 ...
 */
package com.common.ecmanager.modules.order.entity;
...
public class OrderTable extends DataEntity<OrderTable> {
	 ...
	 * @return 订单项
	 */
	public OrderTableItem getOrderItem(String goodsNo,String productType) {
		if (goodsNo != null && getOrderTableItemList() != null) {
			for (OrderTableItem orderItem : getOrderTableItemList()) {
				if (orderItem != null && goodsNo.equalsIgnoreCase(orderItem.getProduct().getId()) && StringUtil.isNotEmpty(productType) && productType.equals(orderItem.getProductType())) {
					return orderItem;
				}
			}
		}
	 ...
	 * @return 订单项
	 */
	public OrderTableItem getOrderItem(String goodsNo,String productType,String reMemberIdString) {
		if (goodsNo != null && getOrderTableItemList() != null) {
			for (OrderTableItem orderItem : getOrderTableItemList()) {
				//区分同一个订单里有两件相同商品商品购买数量不一样
				if (orderItem != null && goodsNo.equalsIgnoreCase(orderItem.getProduct().getId()) && StringUtil.isNotEmpty(productType) && productType.equals(orderItem.getProductType()) && StringUtil.isNotEmpty(reMemberIdString) && reMemberIdString.equals(orderItem.getReMemberIdString())) {
					return orderItem;
				}
			}
		}
