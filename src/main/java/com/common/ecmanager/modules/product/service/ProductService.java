...
import com.common.ecmanager.modules.mem.service.MemMerchantService;
...
import com.common.ecmanager.modules.product.dao.GiftItemDao;
import com.common.ecmanager.modules.product.dao.ProductAreaRefDao;
...
import com.common.ecmanager.modules.product.dao.ProductParameterDao;
...
import com.common.ecmanager.modules.product.entity.ProductSpecificationRef;
...
public class ProductService extends CrudService<ProductDao, Product> {
	...
	public void save(Product product) {// TODO：事物中，多表插入 外键问题
		...
		if (!Utils.isBlank(suffixName)) {
			product.setName(product.getOriginalName() + " " + suffixName);
...
//			BigDecimal b2 = priceRef.getbSupplyPrice();
	 ...
	 * @return
	 */
	public List<Product> queryByGoodsId(String goodsId){
		return productDao.queryByGoodsId(goodsId);
	}
	/**
	 * 根据供应商id查找已上架的商品
	 * @param supplierId
	 * @return
	 */
	public Integer queryIsMarketableBySupId(String supplierId){
		return productDao.queryIsMarketableBySupId(supplierId);
	}
	 ...
	 * @return
	 */
	public OrderTableItem queryReMember(Map<String, Object> map){
		return productDao.queryReMember(map);
	}
	 ...
	 * @return
	 */
	public List<Map<String,Object>> queryProductsByIds(String[] productIds) throws Exception{
		return productDao.queryProductsByIds(productIds);
	}
	 /**
     * 查询出所有未参与限购的商品
     */
	public List<Product> findCommonProducts() throws Exception{
		return productDao.findCommonProducts();
	}
	
	/**
     * 查询专题或内购未添加的产品
     */
	public Page<Product> queryProductsExcludeBySpecialId(Page<Product> page,Product product) throws Exception{
		product.setPage(page);
		page.setList(productDao.queryProductsExcludeBySpecialId(product));
		return page;
	}
}