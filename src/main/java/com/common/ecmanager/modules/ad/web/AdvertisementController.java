 ...
 */
package com.common.ecmanager.modules.ad.web;
...
import com.common.ecmanager.modules.ad.service.AdvertisementPositionService;
import com.common.ecmanager.modules.ad.service.AdvertisementService;
...
public class AdvertisementController extends BaseController {
	...
	public String update(Advertisement advertisement, Model model, RedirectAttributes redirectAttributes) {
		...
		long beginTime = advertisement.getBeginDate().getTime();
		long endTime = advertisement.getEndDate().getTime();
		if(beginTime > endTime) {
			addMessage(redirectAttributes, "结束时间不能小于开始时间");
			return "redirect:"+Global.getAdminPath()+"/ad/advertisement/?repage";
		}
