 ...
 */
package com.common.ecmanager.modules.supplier.web;
...
public class SupplierController extends BaseController {
	...
	public String delete(Supplier supplier, RedirectAttributes redirectAttributes) {
		//判断该供应商下是否有商品已上架,若已上架则不能删除
		Integer count=productService.queryIsMarketableBySupId(supplier.getId());
		if(count>0){
			addMessage(redirectAttributes, "删除失败，该供应商下有商品已上架");
		}else if(count==0){
