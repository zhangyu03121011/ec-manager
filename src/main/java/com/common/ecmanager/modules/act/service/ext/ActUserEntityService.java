 ...
 */
package com.common.ecmanager.modules.act.service.ext;
...
import com.common.ecmanager.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.common.ecmanager.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.common.ecmanager.modules.sys.entity.User(null, userId)))){
