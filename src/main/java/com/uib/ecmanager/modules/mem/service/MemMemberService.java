...
public class MemMemberService extends CrudService<MemMemberDao, MemMember> {
	...
	public MemMember getMemMemberByName(MemMember memMember) {
		return memMemberDao.getMemMemberByName(memMember);
	}
	 ...
	 * @return
	 */
	public Page<MemMember> findPurchaseList(Page<MemMember> page, MemMember memMember) {
		memMember.setPage(page);
		page.setList(memMemberDao.findPurchaseList(memMember));
		return page;
	}
}