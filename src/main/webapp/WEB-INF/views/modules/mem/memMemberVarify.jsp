	...
	<form:form id="inputForm" modelAttribute="memMember" action="${ctx}/mem/memMember/saveVarifyInfo" method="post" class="form-horizontal">
		...
		<%-- <div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:select path="approveFlag" class="input-medium" id="approveFlag">
		...
		<div class="control-group">
			<label class="control-label"> <span class="help-inline" id="error_select"><font color="red">*</font></span>审核备注：</label>
			<div class="controls">
				<form:textarea path="auditFailureDescription" htmlEscape="false" rows="4" maxlength="255" class="input-xxlarge" id="remark"/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="mem:memMember:edit">
