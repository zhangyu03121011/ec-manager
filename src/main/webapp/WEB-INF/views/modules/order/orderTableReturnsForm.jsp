...
<body>
	...
	<form:form id="inputForm" modelAttribute="orderTableReturns"
		...
		<form:hidden path="recommendedId"/>
		...
		<div id="base_info_tab">
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="productName" htmlEscape="false" maxlength="32"
						class="input-xlarge required" readonly="true" />
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="productQuantity" htmlEscape="false" maxlength="32"
						class="input-xlarge required" readonly="true" />
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="retrunDesc" htmlEscape="false" maxlength="32"
						class="input-xlarge required" readonly="true" />
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<c:if test="${orderTableReturns.returnStatus eq 1}">
					    <form:option value="1" label="已处理" />
					</c:if>
					<c:if test="${orderTableReturns.returnStatus eq 2}">
						<form:option value="1" label="已处理" />
						<form:option value="2" label="无法退货" />
						<form:option value="3" label="未处理" />					
					</c:if>
					<c:if test="${orderTableReturns.returnStatus eq 3}">
						<form:option value="1" label="已处理" />
						<form:option value="2" label="无法退货" />
						<form:option value="3" label="未处理" />					
					</c:if>
