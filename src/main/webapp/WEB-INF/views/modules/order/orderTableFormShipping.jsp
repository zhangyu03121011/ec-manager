<%@ page contentType="text/html;charset=UTF-8" import="com.common.ecmanager.common.enums.*" %>
		...
		<form id="shippingForm"  action="${ctx}/order/orderTable/shipping" method="post" class="form-horizontal">
			...
			<div style="height: 330px; overflow-x: hidden; overflow-y: auto;">
				<table class="input" style="margin-bottom: 20px;">
					...
					<tr>
						<th>收货人:</th><td>
						<input name="consignee"  type="text" class="text" value="${orderTable.consignee}" readonly="readonly"/>
						<th>邮编:</th><td>
					...
					<tr>
						<th>地区:</th>
						<td>
							 <input id="areaName" name="areaName" type="text" class="text" value="${orderTable.areaName}" readonly="readonly"/>
						</td>
						<th>地址:</th><td>
						<input name="address"  type="text" class="text" value="${orderTable.address}" readonly="readonly"/>
						</td>
					</tr>
					<tr>
						<th>电话:</th><td>
						<input name="phone"  type="text" class="text" value="${orderTable.phone}" readonly="readonly"/>
						<th>备注:</th><td>
