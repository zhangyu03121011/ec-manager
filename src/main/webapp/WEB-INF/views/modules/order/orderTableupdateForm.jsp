	...
	<form:form id="inputForm" modelAttribute="orderTable" action="${ctx}/order/orderTable/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
			  ...
			  <c:if test="${orderTable.shippingStatus==0}">
			    <form:input path="freight" htmlEscape="false" maxlength="32" class="input" />
			  </c:if>
			  <c:if test="${orderTable.shippingStatus==2}">
			     <form:input path="freight" htmlEscape="false" maxlength="32" class="input" disabled="true"/>
			  </c:if>
				</div>
		</div>
		<div class="control-group">
			...
			<div class="controls" >
				<!-- 	<div style="display: inline;" id="provicediv">
					...
					<div id="areadiv" style="display: none;">
					 ...
					 ${orderTable.areaName}
				 <input type="hidden" id="areaName" name="areaName" class="text"  maxlength="200" value="${orderTable.areaName}"/>
		...
		<div class="control-group">
			...
			<div class="controls">
			  ...
			  <c:if test="${orderTable.shippingStatus==2}">
			     <form:input path="consignee" htmlEscape="false" maxlength="32" class="input"  disabled="true"/> 
			  </c:if>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
			  ...
			  <c:if test="${orderTable.shippingStatus==2}">
				<form:input path="address" htmlEscape="false" maxlength="32" class="input"  disabled="true"/> 
			  </c:if>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			  ...
			  <c:if test="${orderTable.shippingStatus==2}">
			   <form:input path="phone" htmlEscape="false" maxlength="32" class="input"  disabled="true"/> 
			  </c:if>
			</div>
		</div>
	...
	<!-- 商品信息 -->
		...
		<c:forEach items="${orderTableItems}" var="orderTableItem">
			<tr  height="40">
				...
				<td>${orderTableItem.reMemberName}
				<input type="hidden" value="${orderTableItem.reMemberIdString}" id="${orderTableItem.reMemberIdString}"/>
				</td>
				<td>${orderTableItem.reMemberPhone}</td>
				<td>
