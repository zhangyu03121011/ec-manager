...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/product/inAppPurchase/formView?id=${product.specialId}">内购基本信息</a></li>
		...
		<c:choose>
			...
			<c:otherwise>
			<li><a href ="#" name="submit" onclick="$('#inputForm').submit();return false">内购商品添加</a></li>
			</c:otherwise>
		</c:choose>
	</ul>
	<form:form id="inputForm" modelAttribute="special" action="${ctx}/product/inAppPurchase/saveForm" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="percent" htmlEscape="false" maxlength="255" class="input required"/>%
			</div>
		</div>
		<div class="control-group">
