...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/product/inAppPurchase/">内购信息列表</a></li>
		<shiro:hasPermission name="product:special:save"><li><a href="${ctx}/product/inAppPurchase/form">内购信息添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="special" action="${ctx}/product/inAppPurchase/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="special">
			<tr>
				<td><a href="${ctx}/product/inAppPurchase/specialView?id=${special.id}">
				...
				<shiro:hasPermission name="product:special:edit"><td>
    				...
    				<a href="${ctx}/product/inAppPurchase/updateFormView?id=${special.id}">修改</a>
					<a href="${ctx}/product/inAppPurchase/delete?id=${special.id}" onclick="return confirmx('确认要删除该内购信息吗？', this.href)">删除</a>
