	...
	<form:form id="inputForm" modelAttribute="product" action="${ctx}/product/product/save" method="post" class="form-horizontal">
		...
		<div id="base_info_tab">
			...
			<div class="control-group">
				...
				<div class="controls">
					<sys:treeselect id="productCategory" name="productCategoryId"
						...
						notAllowSelectRoot="false" notAllowSelectParent="true" cssClass="input-small required" />
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="productNo" htmlEscape="false" class="input-xlarge required" />
					<span class="help-inline"><font color="red">*</font> </span>
				</div>
			</div>
			<%--<div class="control-group">
