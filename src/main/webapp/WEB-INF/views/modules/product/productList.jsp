...
<script type="text/javascript">
	...
	function resetBtn(){
		...
		$("#productCategoryName").attr("value","");
...
<%-- 			<li><label>搜索关键词：</label> <form:input path="keyword" htmlEscape="false" maxlength="32" class="input-medium" /></li> --%>
			<li><label>商品分类：</label> <sys:treeselect id="productCategory" name="productCategoryId" value="${product.productCategoryId}" labelName="productCategory.name"
					labelValue="${product.productCategory.name}" title="商品分类" url="/product/productCategory/treeData" notAllowSelectParent="true" module="product" allowClear="true"   cssClass="input-small" /></li>
			<%-- <li><label>PC：</label> 
...
<%-- 			</form:select> --%>
				...
				<li class="btns"><input  class="btn btn-primary" type="button" onclick="resetBtn()" value="重置" /></li>
