...
<script type="text/javascript">
	...
	根据分类ID查品牌
	*/
	function productCategoryTreeselectCallBack(v, h, f) {
		if(v=="ok"){
			$("#brandId option[value='']").attr("selected", true);
			$(".select2-chosen").html("");
			var productCategoryId = $("#productCategoryId").val();
			console.info($("#productCategoryId").val());
			$.ajax({
				url: "${ctx}/product/brand/brandList?productCategoryId="+productCategoryId,
				type: "GET",
				dataType: "json",
				success: function(data) {
					console.info(data);
	...
	<form:form id="inputForm" modelAttribute="product"
		...
		<div id="base_info_tab">
			<div class="control-group">
				...
				<div class="controls">
					<sys:treeselect id="productCategory" name="productCategoryId"
						...
						url="/product/productCategory/treeData" notAllowSelectParent="true" module="product"
			...
			<div class="control-group">
				...
				<div class="controls">
<!-- 					<select id="brandId" name="brandId" class="input-xlarge required"> -->
...
<!-- 					</select> -->
		...
		-->
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="residueStock" htmlEscape="false" maxlength="11"
						class="input-xlarge digits number required" readonly="true"/> </span>
				</div>
			</div>
			<div class="control-group">
			<label class="control-label">销量：</label>
